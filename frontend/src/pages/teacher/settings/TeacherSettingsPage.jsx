  ...
  return (
    <>
      ...
      <div className="ui-split ui-split--even">
        ...
        <Card title={t('teacher.settings.notifications')}>
          <Link className="ui-btn ui-btn--ghost" to="/app/notifications/preferences"><Bell size={16} aria-hidden="true" /> {t('teacher.settings.notificationPreferences')}</Link>
        </Card>
      </div>
    </>
  )
