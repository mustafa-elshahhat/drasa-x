...
export const NAV_ITEMS = [
  ...
  { key: 'student', labelKey: 'nav.myLearning', to: '/app/student', icon: GraduationCap, roles: [ROLES.STUDENT] },
  ...
  { key: 'student-notifications', labelKey: 'student.notifications.title', to: '/app/student/notifications', icon: Bell, roles: [ROLES.STUDENT] },
  ...
  { key: 'teacher', labelKey: 'teacher.dashboard.title', to: '/app/teacher', icon: BarChart3, roles: [ROLES.TEACHER, ROLES.SCHOOL_ADMIN] },
  { key: 'teacher-classes', labelKey: 'teacher.classes.title', to: '/app/teacher/classes', icon: Users, roles: [ROLES.TEACHER, ROLES.SCHOOL_ADMIN] },
  { key: 'teacher-subjects', labelKey: 'teacher.subjects.title', to: '/app/teacher/subjects', icon: BookOpen, roles: [ROLES.TEACHER, ROLES.SCHOOL_ADMIN] },
  { key: 'teacher-students', labelKey: 'teacher.students.title', to: '/app/teacher/students', icon: GraduationCap, roles: [ROLES.TEACHER, ROLES.SCHOOL_ADMIN] },
  { key: 'teacher-quizzes', labelKey: 'teacher.quizzes.title', to: '/app/teacher/quizzes', icon: ClipboardList, roles: [ROLES.TEACHER, ROLES.SCHOOL_ADMIN] },
  { key: 'teacher-generate', labelKey: 'teacher.generate.title', to: '/app/teacher/quiz-generate', icon: Bot, roles: [ROLES.TEACHER, ROLES.SCHOOL_ADMIN] },
  { key: 'teacher-office-hours', labelKey: 'teacher.officeHours.title', to: '/app/teacher/office-hours', icon: CalendarClock, roles: [ROLES.TEACHER, ROLES.SCHOOL_ADMIN] },
  { key: 'teacher-notifications', labelKey: 'teacher.notifications.title', to: '/app/teacher/notifications', icon: Bell, roles: [ROLES.TEACHER, ROLES.SCHOOL_ADMIN] },
  ...
  // Shared communication surfaces (Phase 13) — tenant roles (SystemAdmin is platform-scope).
  ...
  { key: 'notifications-center', labelKey: 'notifications.title', to: '/app/notifications', icon: Bell, roles: [ROLES.STUDENT, ROLES.TEACHER, ROLES.PARENT, ROLES.SCHOOL_ADMIN] },
