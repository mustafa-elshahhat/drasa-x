...
export const queryKeys = {
  ...
  student: {
    ...
    lessonDetail: (userId, lessonId) => scopedKey(userId, ['student', 'lesson-detail', lessonId]),
    materials: (userId, lessonId) => scopedKey(userId, ['student', 'materials', lessonId]),
    material: (userId, materialId) => scopedKey(userId, ['student', 'material', materialId]),
  ...
  teacher: {
    ...
    grades: (userId) => scopedKey(userId, ['teacher', 'grades']),
    ...
    // Fix pass — Teacher communities (greenfield) + badge award (mirrors school.communities /
    // teacher.studentPoints shape below).
    communities: (userId) => scopedKey(userId, ['teacher', 'communities']),
    communityMembers: (userId, communityId) => scopedKey(userId, ['teacher', 'communities', communityId, 'members']),
    communityPosts: (userId, communityId) => scopedKey(userId, ['teacher', 'communities', communityId, 'posts']),
    badgeCatalog: (userId) => scopedKey(userId, ['teacher', 'badge-catalog']),
    studentBadges: (userId, studentId) => scopedKey(userId, ['teacher', 'students', studentId, 'badges']),
    homework: (userId) => scopedKey(userId, ['teacher', 'homework']),
    homeworkItem: (userId, homeworkId) => scopedKey(userId, ['teacher', 'homework', homeworkId]),
    homeworkSubmissions: (userId, homeworkId) => scopedKey(userId, ['teacher', 'homework', homeworkId, 'submissions']),
    competitions: (userId) => scopedKey(userId, ['teacher', 'competitions']),
    competition: (userId, competitionId) => scopedKey(userId, ['teacher', 'competitions', competitionId]),
    competitionSubmissions: (userId, competitionId) => scopedKey(userId, ['teacher', 'competitions', competitionId, 'submissions']),
    competitionLeaderboard: (userId, competitionId) => scopedKey(userId, ['teacher', 'competitions', competitionId, 'leaderboard']),
    notifications: (userId) => scopedKey(userId, ['teacher', 'notifications']),
    officeHours: (userId) => scopedKey(userId, ['teacher', 'office-hours']),
    officeHourBookings: (userId, sessionId) => scopedKey(userId, ['teacher', 'office-hours', sessionId, 'bookings']),
  },
  parent: {
  ...
  school: {
    ...
    user: (userId, targetUserId) => scopedKey(userId, ['school', 'users', 'detail', targetUserId]),
    class: (userId, classId) => scopedKey(userId, ['school', 'classes', classId]),
    enrollments: (userId, classId) => scopedKey(userId, ['school', 'enrollments', classId || 'all']),
    ...
    communityMembers: (userId, communityId) => scopedKey(userId, ['school', 'communities', communityId, 'members']),
    communityPosts: (userId, communityId) => scopedKey(userId, ['school', 'communities', communityId, 'posts']),
    ...
    suggestions: (userId) => scopedKey(userId, ['school', 'suggestions']),
    // Fix pass — Phase 14 gamification rules editor (SchoolAdmin-exclusive write).
    gamificationRules: (userId) => scopedKey(userId, ['school', 'gamification-rules']),
  },
