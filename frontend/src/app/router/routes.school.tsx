...
export const schoolRoutes: AppRoute[] = [
  ...
  r('/app/school/students', 'school.pages.students.title', SchoolUsersPage, { role: 'Student', canCreate: true }),
  r('/app/school/students/:userId', 'school.pages.userDetails.title', SchoolUserDetailPage),
  r('/app/school/teachers', 'school.pages.teachers.title', SchoolUsersPage, { role: 'Teacher', canCreate: true }),
  r('/app/school/teachers/:userId', 'school.pages.userDetails.title', SchoolUserDetailPage),
  r('/app/school/parents', 'school.pages.parents.title', SchoolUsersPage, { role: 'Parent', canCreate: true }),
