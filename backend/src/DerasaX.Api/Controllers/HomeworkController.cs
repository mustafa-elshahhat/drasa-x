...
{
    /// <summary>
    /// Phase 5 closure — homework / general (non-quiz) assignment lifecycle. Teacher/SchoolAdmin
    /// author, publish, review and grade; students list, submit and view their own submission.
    /// Tenant-isolated (cross-tenant ids → 404); relationship/role gated per action.
    /// </summary>
    [ApiController]
